      ...
      child: Container(
        ...
        child: Column(
          children: [
                ...
                itemBuilder: (context, index) => InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: selectedDay == listDays[index]
                            ? const Color(colorBlueGray)
                            : Colors.white),
                    child: Center(
                        child: Text(
                      listDays[index],
              ...
              child: ListView.builder(
                  itemBuilder: (context, index) => InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              border:
                                  Border.all(color: const Color(colorBlueGray)),
                              borderRadius: BorderRadius.circular(30),
                              color: time == listHours[index]
                                  ? const Color(colorBlueGray)
                                  : Colors.white),
                          child: Center(
            ...
            MaterialButton(
              onPressed: () => widget.callback(selectedDay, time),
              child: Row(
