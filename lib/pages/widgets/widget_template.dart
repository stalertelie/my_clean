...
class WidgetTemplate extends Object {
  ...
  static getActionButtonWithIcon(
          {required String title,
          required VoidCallback callback,
          Color? color,
          IconData? ico,
  ...
  static Future<DateTimeRange?> showDateRangeChooser(
          BuildContext ctx, DateTimeRange range) =>
      showDateRangePicker(
        context: ctx,
  ...
  static Future<TimeOfDay?> showTimeChoooser(BuildContext ctx) =>
      showTimePicker(
        context: ctx,
